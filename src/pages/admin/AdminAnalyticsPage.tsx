          ...
          {analytics.ordersByStatus.map((status, index) => {
            ...
            return (
              <div key={index} className="text-center">
                <div className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${colors[status.status as keyof typeof colors] || 'bg-gray-100 text-gray-800'}`}>
                  {status.status}
                </div>
                <div className="mt-2">
